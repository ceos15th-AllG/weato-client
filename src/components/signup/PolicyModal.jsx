  ...
  return (
    <Layout>
      ...
      <ContentBox ref={scrollRef} onScroll={handleScroll}>
        ...
        <span className="text">
          본 개인 민감정보취급방침은 회사가 제공하는 Weato (이하 “서비스”)에
        ...
        <ul className="list">
          ...
          <li className="listitem">
            “회사”는 이용자들이 “회사”의 개인 민감정보 보호정책 또는 이용약관의
            내용에 대하여 「동의 합니다.」버튼을 클릭할 수 있는 절차를 마련하여,
            「동의합니다.」버튼을 클릭하면 개인 민감정보 수집 및 이용에 대해
            동의한 것으로 봅니다.
          </li>
        </ul>
        ...
        <ul className="list">
          ...
          <li className="listitem">
            “회사”는 이용자가 회원자격을 유지하고 있는 동안 수집된 이용자의
            개인정보를 보유·이용할 수 있으며, 이용자가 탈퇴하거나 자격을 상실할
            경우에는 이용자의 별도 요청이 없더라도 수집된 회원정보를 삭제 및
            파기합니다. 단, 이용자의 회원탈퇴 또는 회원자격 상실에도 불구하고
            다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존하며,
            이용자의 처리정지, 삭제 요구권의 대상이 되지 아니합니다.
          </li>
        </ul>
        ...
        <ul className="list">
          ...
          <li className="listitem">
            ...
            정지되고, “회사”는 휴면회원의 개인정보를 제1항 및 제2항에 따른 정보
            보유의 대상이 아닌 한 다른 ID와 별도로 관리합니다. “회사”는 휴면회원
            처리 예정일 30일 전 해당 사실을 사전 안내하며, 회원은 휴면회원
            처리일 이후에 서비스에서 휴면상태 해지신청을 하는 즉시 다시
        ...
        <span className="text">
          귀하께서는 “Weato”의 민감정보 수집 및 이용에 대한 동의 거부권이 있으며
          동의 거부 시에는 Weato 서비스 이용이 불가능합니다.
        </span>
      </ContentBox>
